  ...
  return (
    ...
    >
      <motion.div
        ...
        data-pdf-capture="detailed-report-modal"
        data-testid="detailed-report-modal"
      >
        {/* Header */}
...
const AgentFindingsExplorer: React.FC<AgentFindingsExplorerProps> = ({
  ...
  const { navigateToMockReport, navigateToAgentExplorer } = useAppContext();
    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          data-pdf-capture="agent-findings-explorer"
          data-testid="agent-findings-explorer-modal"
        >
          {/* Header */}
              ...
              >
                ...
                <div className="overflow-y-auto max-h-[calc(95vh-200px)] bg-gradient-to-br from-blue-100 via-blue-50 to-cyan-100 relative overflow-hidden">
                  ...
                  <div className="p-6 relative z-10">
                    {/* Single Comprehensive View - All Content */}
                    <motion.div
                    ...
                    >
                      <div className="text-center mb-8">
                        <h2 className="text-3xl font-bold text-slate-900 mb-4">Process Analysis Report</h2>
                        <p className="text-lg text-slate-600">Complete analysis with identified patterns, inefficiencies, and automation opportunities</p>
                      </div>

                      {/* Question-specific content if available */}
                      {questionData ? (
                        <div className="mb-12">
                      ...
                      <div className="metric-card p-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                          <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-xl p-6 border border-blue-200">
                            <div className="flex items-center justify-between mb-4">
                              ...
                              <div className="text-right">
                                <div className="text-3xl font-bold text-slate-900">{findings.efficiencyMetrics.overallEfficiency}%</div>
                          ...
                          <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-6 border border-green-200">
                            <div className="flex items-center justify-between mb-4">
                              ...
                              <div className="text-right">
                                <div className="text-3xl font-bold text-slate-900">${(findings.efficiencyMetrics.costSavingsPotential / 1000000).toFixed(1)}M</div>
                                <div className="text-sm text-slate-600">Cost Savings Potential</div>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl p-6 border border-purple-200">
                            <div className="flex items-center justify-between mb-4">
                              ...
                              <div className="text-right">
                                <div className="text-3xl font-bold text-slate-900">{findings.efficiencyMetrics.timeSavingsPotential}h</div>
                                <div className="text-sm text-slate-600">Daily Time Savings</div>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-xl p-6 border border-amber-200">
                            <div className="flex items-center justify-between mb-4">
                              ...
                              <div className="text-right">
                                <div className="text-3xl font-bold text-slate-900">{findings.efficiencyMetrics.automationReadiness}%</div>
                                <div className="text-sm text-slate-600">Automation Readiness</div>
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="bg-slate-50 rounded-xl p-6 mb-8">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <button
                              onClick={() => generateComprehensivePDFReport(selectedQuestion)}
                              className="flex items-center justify-center space-x-2 px-4 py-3 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-lg hover:from-blue-600 hover:to-blue-700 transition-all duration-300 shadow-lg hover:shadow-xl"
                            >
                              <FileText className="w-5 h-5" />
                              <span className="font-medium">Export PDF Report</span>
                            </button>
                            <button className="flex items-center justify-center space-x-2 px-4 py-3 bg-gradient-to-r from-green-500 to-green-600 text-white rounded-lg hover:from-green-600 hover:to-green-700 transition-all duration-300 shadow-lg hover:shadow-xl">
                              <Share className="w-5 h-5" />
                              <span className="font-medium">Share Results</span>
                            </button>
                            <button className="flex items-center justify-center space-x-2 px-4 py-3 bg-gradient-to-r from-purple-500 to-purple-600 text-white rounded-lg hover:from-purple-600 hover:to-purple-700 transition-all duration-300 shadow-lg hover:shadow-xl">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                          {findings.userBehaviorPatterns.map((pattern, index) => (
                            <motion.div
                              ...
                              className="bg-white/90 backdrop-blur-md rounded-xl p-6 border border-white/40 shadow-lg"
                            >
                              <div className="flex items-start justify-between mb-4">
                                <div>
                                  <h4 className="text-lg font-bold text-slate-900 mb-2">{pattern.pattern}</h4>
                              ...
                              <div className="space-y-3">
                                <div className="flex items-center justify-between">
                                  ...
                                  <span className="text-lg font-bold text-slate-900">{pattern.frequency.toLocaleString()}</span>
                                </div>
                                <div className="flex items-center justify-between">
                      ...
                      <div className="metric-card p-8">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                          {/* System Usage */}
                          <div>
                            <h4 className="text-lg font-bold text-slate-900 mb-4">System Usage & Efficiency</h4>
                            <div className="space-y-4">
                          ...
                          {/* Workflow Stages */}
                          <div>
                            <h4 className="text-lg font-bold text-slate-900 mb-4">Workflow Stage Performance</h4>
                            <div className="grid grid-cols-1 gap-4">
                              {findings.systemAnalysis.workflowStages.map((stage, index) => (
                                <motion.div
                                  ...
                                  transition={{ delay: index * 0.1 }}
                                  className="bg-white/90 backdrop-blur-md rounded-lg p-4 border border-white/40 shadow-sm"
                                >
                                  <div className="flex items-center justify-between">
                                    <div>
                                      <h5 className="font-semibold text-slate-900">{stage.stage}</h5>
                                      <div className="text-sm text-slate-600">{stage.time}m average</div>
                                    </div>
                                    <div className="text-right">
                                      <div className="text-lg font-bold text-blue-600">{stage.efficiency}%</div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                          {analysisHistory.slice(0, 6).map((item, index) => (
                            <motion.div
                              ...
                              animate={{ opacity: 1, y: 0 }}
                              transition={{ delay: index * 0.1 }}
                              className="bg-white/90 backdrop-blur-md rounded-xl p-6 border border-white/40 shadow-lg hover:shadow-xl transition-shadow"
                            >
                              <div className="flex items-center space-x-3 mb-4">
                                ...
                                <div>
                                  ...
                                  <p className="text-sm text-slate-600">{item.enterpriseSystem}</p>
                                </div>
                              </div>
                              ...
                              <div className="space-y-2">
                                <div className="flex justify-between">
                                  ...
                                  <span className="text-sm font-semibold text-green-600">{item.results.costSavings}</span>
                                </div>
                                <div className="flex justify-between">
                                  <span className="text-xs text-slate-600">ROI</span>
                                  <span className="text-sm font-semibold text-blue-600">{item.results.roi}%</span>
                                </div>
                              </div>
